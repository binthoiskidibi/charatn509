...
local FarmSelect = Tabs.Main:AddDropdown("FarmSelect", {
    Title = "Farm ",
...
local FarmsSelect = Tabs.Main:AddToggle("FarmsSelect", {
    Title = "Farm",
    Description = "Farm select ",
    Default = false
})
...
spawn(function()
    while wait(1) do
        if _G.FarmsSelect then
            ...
            -- Khi tắt toggle, tắt tất cả farm
            _G.Level = false
            _G.Auto_Cake_Prince = false
            _G.AutoFarm_Bone = false
        end
